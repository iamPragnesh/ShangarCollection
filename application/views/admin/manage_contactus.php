                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="element-wrapper">
                                        ...
                                        <h4 class="element-header">Contact Us</h4>
                                        <div class="element-box row col-12">
                                            ...
                                            <div class="col-6">
                                                <p class="form-header" align="right">
                                                    <button onclick="delete_link('contactus/<?php echo base64_encode(base64_encode(0)); ?>')" class="btn btn-danger" data-target="#exampleModal1" data-toggle="modal">Delete All Contacts</button>
                                                </p>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($contactus as $data) {
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <a onclick="delete_link('contactus/<?php echo base64_encode(base64_encode($data->contact_id)); ?>')" style="cursor: pointer"  data-toggle="tooltip" data-placement="bottom" title="Remove Data">
