            ...
            <div class="row align-items-center">
                ...
                <div class="col d-lg-none ">
                    <div class="ec-header-bottons">
                        ...
                        <!-- Header Cart Start -->
                        <a href="<?php echo base_url('member-wishlist'); ?>" class="ec-header-btn ec-header-wishlist">
                            <div class="header-icon"><img src="<?php echo base_url(); ?>assets/images/icons/wishlist.svg"
                        ...
                        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
                            <div class="header-icon"><img src="<?php echo base_url(); ?>assets/images/icons/cart.svg" class="svg_img header_svg" alt="" /></div>
                            <!--<span class="ec-header-count cart-count-lable">4</span>-->
                        </a>
                        <!-- Header Cart End -->
                        <!-- Header menu Start -->
                        <a href="#ec-mobile-menu" class="ec-header-btn ec-side-toggle d-lg-none">
                            <img src="<?php echo base_url(); ?>assets/images/icons/menu.svg" class="svg_img header_svg" alt="icon" />
                        </a>
                        <!-- Header menu End -->
                    </div>
                </div>
                ...
                <div class="ec-flex">
                    ...
                    <div class="align-self-center">
                        <div class="header-logo">
                            <a href="<?php echo base_url(); ?>home"><img src="<?php echo base_url(); ?>assets/images/logo/Shangar2.png" alt="Site Logo" /><img
                                    class="dark-logo" src="<?php echo base_url(); ?>assets/images/logo/Shangar2.png" alt="Site Logo"
                    ...
                    <div class="align-self-center">
                        <div class="header-search">
                            <!--<form class="ec-btn-group-form" method="post"  id="filter_form">-->
                                <input class="form-control" onkeypress="search_enter(event);" id="transcript" placeholder="Enter Your Product Name..." type="text">
                                <button class="submit" type="button"><i class="ecicon eci-microphone" onclick="startDictation()"></i></button>
                                <!--<button class="submit" type="submit"><img src="<?php echo base_url(); ?>assets/images/icons/search.svg" class="svg_img header_svg" alt="" /></button>-->
                            <!--</form>-->
                        </div>
...
//                                
                                ?>
                                <div class="header-icon"><img src="<?php echo base_url(); ?>assets/images/icons/cart.svg" class="svg_img header_svg" alt="" /></div>
                                <!--<span class="ec-header-count cart-count-lable"><?php // echo $item_count; ?></span>-->
                            </a>
                            <!-- Header Cart End -->
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="header-search">
                        <form class="ec-btn-group-form" action="#">
                            ...
                            <button class="submit" type="submit"><img src="<?php echo base_url(); ?>assets/images/icons/search.svg"
                ...
                <div class="col-md-12 align-self-center">
                    <div class="ec-main-menu">
                        <ul>
                            ...
                            <li class="dropdown position-static"><a href="<?php  echo base_url(); ?>collections/main-collection/<?php echo base64_encode(base64_encode($maindata->category_id)); ?>"><?php echo $maindata->name; ?></a>
                                <ul class="mega-menu d-block">
                                    <li class="d-flex">
                                        ...
                                        foreach ($sub as $subdata)
                                         {
                                        ?>
                                        <ul class="d-block"><a href="<?php  echo base_url(); ?>collections/sub-collection/<?php echo base64_encode(base64_encode($subdata->category_id)); ?>"><?php echo $subdata->name; ?></a>
                                            <?php
                                            ...
                                            ?>
                                            <li class="menu_title"><a href="<?php  echo base_url(); ?>collections/peta-collection/<?php echo base64_encode(base64_encode($petadata->category_id)); ?>"><?php echo $petadata->name; ?></a></li>
                                            </li>
                                            <?php
                                                }
                                                ?>
                                            <li class="menu_title"><a href="<?php  echo base_url(); ?>collections/sub-collection/<?php echo base64_encode(base64_encode($subdata->category_id)); ?>">View All Data</a></li>
                        ...
                        ?>
                            <li class="dropdown"><a href="<?php echo base_url(); ?>collections/todays-offer">Today's Offer</a>
                            </li>
                            <li class="dropdown"><a href="<?php echo base_url(); ?>contact-us">Contact Us</a>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="ec-menu-inner">
            <div class="ec-menu-content">
                <ul>
                    ...
                    <li><a href="javascript:void(0)">Main menu</a>
                        <ul class="sub-menu">
                            <li>
                            ...
                            <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive"
                                                                                        src="<?php echo base_url(); ?>assets/images/menu-banner/1.jpg" alt=""></a>
                            </li>
                        </ul>
                    </li>
                                    ...
                                    <div class="ec-pro-content">
                                        ...
                                        <div class="ec-cart-inner">
                                            <div class="ec-cart-top">
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/icons/cart.svg" style="margin-left: 25%;" class="svg_img header_mk" alt="" />
                                                <p style="font-size: x-large; text-align: center; padding-top: 40px;">Login To view Product</p>
                                            </div>
                                            <div class="cart_btn">
